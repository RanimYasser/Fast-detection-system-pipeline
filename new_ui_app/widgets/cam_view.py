...
class CameraView(QWidget):
    def __init__(self, start_callback, stop_callback):
        ...
        self.video_label.setMaximumHeight(900)
       # self.video_label.setMaximumWidth(1500)

        self.video_label.setAlignment(Qt.AlignCenter)
        self.video_label.setStyleSheet(
            "border: 2px solid #2C3238; background-color: #23282D;"
        )
        ...
        for btn, hover in [
            (self.start_button, "#144678"),
            (self.stop_button, "#2C3238"),
        ]:
            btn.setStyleSheet(f"""
                QPushButton {{
